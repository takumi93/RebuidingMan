...
public class RobotAttackChargeAxe : MonoBehaviour
{
    [SerializeField]
    ...
    void Start()
    {
        ...
        ChargeDamage = robotAttackMethod.axeDamageB;
    }
