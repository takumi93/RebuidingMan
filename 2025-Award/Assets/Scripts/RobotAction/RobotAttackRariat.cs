...
public class RobotAttackRariat : MonoBehaviour
{
    [SerializeField]
    ...
    void Start()
    {
        ...
        RariatDamage = robotAttackMethod.normalDamageB;
    }
